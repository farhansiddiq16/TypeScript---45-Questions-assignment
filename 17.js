...
let guestslist2 = ["Zakir", "Farhan", "Nabeel", "Ali", "Adeel", "Salman", "Sabir"];
let newMsg = "Unfortunatly, we can only invite two guest due to unavailability of space.";
guestslist2.map((item2) => console.log(`Dear ${item2}, ${newMsg}`));
...
guestslist2.map((item5) => (console.log(`Dear ${item5}, ${newMsg2}`)));
